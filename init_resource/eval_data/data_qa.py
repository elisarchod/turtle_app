QA_EXAMPLES = [{
    "input": {"messages": "recommend 3 comedy movies"}, "output": {
        "answer": """
1. **The Big Sick**
...
3. **Mr. Roosevelt**
   - Plot: Emily Martin returns to her hometown to come to terms with her past, staying with her ex-boyfriend and his new girlfriend. The film explores Emily's journey of self-discovery and the awkwardness of navigating relationships with humor and heart."""}},
    {
        "input": {"messages": "recommend 2 bollywood movies"}, "output": {
        "answer": """
...
#
#     {
#         "input": {"messages": "recent movies i downloaded in torrent?"}, "output": {
#         "answer": """The recent movies you've downloaded via torrent are:
