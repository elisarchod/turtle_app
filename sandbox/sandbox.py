...
"""
result: AddableValuesDict = agent.invoke({"messages": "recommend 2 bollywood movies"}, )  # config=config,
result['messages'][-1].pretty_print()
"""
...
"""
result: AddableValuesDict = agent.invoke({"messages": "recent movies i downloaded in torrent?"}, )  # config=config,
result['messages'][-1].pretty_print()
"""
