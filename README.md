...
- **qBittorrent Web UI**: http://localhost:15080 (credentials set in `.env`)
...
- **qBittorrent**: `http://localhost:15080` (credentials set in `.env`)
- **Samba**: Network share `\\localhost\daves` (credentials set in `.env`)
