...
from research_rabbit.prompts import query_writer_instructions, \
...
def summarize_sources(state: SummaryState):
    ...
    if existing_summary:
        human_message_content = (f"Extend the existing summary: {existing_summary}\n\n"
...
def route_research(state: SummaryState, config: RunnableConfig) -> Literal[
