...
from infrastructure.mcp.server.config import settings
from infrastructure.mcp.server.clients.qbittorrent_client import QBittorrentClient
from infrastructure.mcp.server.tools.qbittorrent_tools import register_tools
...
def run_server():
    ...
    subprocess.run([
        ...
        "infrastructure.mcp.server.server:mcp",
        "--transport", "http"
    ])
