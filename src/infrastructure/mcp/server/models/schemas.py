...
class TorrentListResponse(BaseModel):
    ...
    count: int | None = Field(None, description="Number of torrents returned")
    torrents: list[Any] | None = Field(None, description="List of torrent objects with details")
...
class TorrentInfoResponse(BaseModel):
    ...
    success: bool = Field(description="Whether the operation succeeded")
    info: Any | None = Field(None, description="Detailed torrent information including files")
    error: str | None = Field(None, description="Error message if operation failed")
...
class TorrentActionResponse(BaseModel):
    ...
    result: Any | None = Field(None, description="API response from qBittorrent")
    error: str | None = Field(None, description="Error message if operation failed")
...
class SearchResponse(BaseModel):
    ...
    results: Any | None = Field(None, description="Search results with torrent details")
    error: str | None = Field(None, description="Error message if operation failed")
...
class PreferencesResponse(BaseModel):
    ...
    success: bool = Field(description="Whether the operation succeeded")
    preferences: Any | None = Field(None, description="qBittorrent application settings")
    error: str | None = Field(None, description="Error message if operation failed")
