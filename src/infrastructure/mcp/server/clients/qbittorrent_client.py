...
class QBittorrentClient:
    ...
    async def list_torrents(self, filter: str | None = None, category: str | None = None) -> list[dict]:
    ...
    async def add_torrent(self, urls: str, savepath: str | None = None, category: str | None = None, paused: bool = False) -> str:
