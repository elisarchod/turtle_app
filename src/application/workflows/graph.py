...
from infrastructure.llm.factory import create_supervisor_llm
from infrastructure.mcp.client.tools import load_qbittorrent_tools
from application.agents.nodes import library_scan_node, movie_retriever_agent, subtitle_agent, create_torrent_agent
from application.agents.supervisor import SupervisorNodeCreator
...
class WorkflowGraph:
    ...
    def __init__(self, tools: dict[str, ToolAgent | Callable], name: str) -> None:
        ...
        self.name: str = name
        self.nodes: dict[str, ToolAgent | Callable] = tools
...
def create_movie_workflow(torrent_tools: list | None = None) -> WorkflowGraph:
...
movie_workflow_agent: WorkflowGraph | None = None
movie_workflow_graph: CompiledStateGraph | None = None
